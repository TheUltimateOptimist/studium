...
public class CircleObject extends GameObject {
  ...
  public CircleObject(String id, Playground pg, double x, double y, double vx, double vy,
      double egoRad, Color color) {
    super(id, pg, x, y, vx, vy);
    this.egoRad = egoRad;
    this.artist = new CircleArtist(this, egoRad, color);
  }
