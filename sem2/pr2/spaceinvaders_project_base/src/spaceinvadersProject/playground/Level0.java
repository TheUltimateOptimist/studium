 ...
 * </ul>
 */
public class Level0 extends Playground {

  public static final int LEVEL2STARS = 80;
  public static final double BONUS_DURATION = 1.;
  public static final double ENEMYSPEEDX = 400;
  public static final double ENEMYSPEEDY = 50;
  public static final double ENEMYSCALE = 1.0;
  public static final double ENEMYSHOTSPEED = 10;
  public static final int NRSHARDS = 50;
  public static final double EXPL_DURATION = 1.;
  public static final int NR_ENEMIES = 5;
  public static final int NR_COLLECT = 15;
  ...
  public static final double SHOTSPEED = 1000;
  public static final double EGOSPEED = 1000;
  ...
  public GameObject createEgoShot(String shotName, GameObject ego) {
    ...
    GameObject ss = new RectObject(shotName, this, ego.getX(), ego.getY(), 0,
        -1. * SHOTSPEED, 4, 12, Color.CYAN).setController(simpleshot);
